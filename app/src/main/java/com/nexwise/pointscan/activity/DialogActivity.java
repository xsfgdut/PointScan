...
//                        Toast.makeText(DialogActivity.this, "Begin Parse Data", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(DialogActivity.this, "Parse Succeed", Toast.LENGTH_SHORT).show();
                    isLoaded = true;
                    if (isLoaded) {
                        showPickerView();
                    } else {
//                        Toast.makeText(DialogActivity.this, "Please waiting until the data is parsed", Toast.LENGTH_SHORT).show();
                    }
                    break;

                case MSG_LOAD_FAILED:
//                    Toast.makeText(DialogActivity.this, "Parse Failed", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
...
//                Toast.makeText(DialogActivity.this, tx, Toast.LENGTH_SHORT).show();
                finish();
            }
        })
